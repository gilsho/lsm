...
def runExperiment(params, exp_dir):
	...
	syn0e = Synapse("syn_generic", {"erev":params['erev_e'][0], "tau_syn":params['tau_syn'], "g_max":params['g_max'][0], "lambda":params['lam'][0], "t_xmt":params['t_xmt'][0]})
	syn0i = Synapse("syn_generic", {"erev":params['erev_i'][0], "tau_syn":params['tau_syn'], "g_max":params['g_max'][0], "lambda":params['lam'][0], "t_xmt":params['t_xmt'][0]})
	s0.AddSynapse(syn0e)
	s0.AddSynapse(syn0i)
	...
	syn1e = Synapse("syn_generic", {"erev":params['erev_e'][1], "tau_syn":params['tau_syn'], "g_max":params['g_max'][1], "lambda":params['lam'][1], "t_xmt":params['t_xmt'][1]})
	syn1i = Synapse("syn_generic", {"erev":params['erev_i'][1], "tau_syn":params['tau_syn'], "g_max":params['g_max'][1], "lambda":params['lam'][1], "t_xmt":params['t_xmt'][1]})
	s1.AddSynapse(syn1e)
	s1.AddSynapse(syn1i)
